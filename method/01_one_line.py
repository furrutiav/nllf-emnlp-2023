...
if __name__ == "__main__":
    ...
    verbose:                A boolean value that controls whether status and progress messages will be printed during script 
                            execution, providing information about the weak labeling process.
    """
